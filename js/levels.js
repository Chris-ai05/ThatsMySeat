...
const LEVELS = [
  ...
  /* ------------------------------------------------------------------
     ...
     Lösung: 1A Robin · 1B Olli · 1C Sommer* · 1D Kim
             2A Deniz · 2B Yara · 2C Mats · 2D Selma
             3A Juri · 3B Pia · 3C Ayla · 3D Finn
     Deduktion: Finn/Pia über umschriebene Props · Robin nur über Ollis
     Hinweis + Sommers festen Platz · Kim per Elimination · Essens-Paar
     Deniz/Selma · Ketten Pia→Ayla→Mats und Deniz→Juri.
     ------------------------------------------------------------------ */
  {
    id: 6,
    ...
    seatScale: 0.95,
    intro:
      "Der Bus von oben, vorn ist oben – links ist die Fahrerseite. „Direkt neben“ meint das eigene Sitzpaar, " +
      "der Gang dazwischen zählt nicht. „Vor“ und „hinter“ beziehen sich auf die Sitzreihen. " +
      "Nicht jeder Hinweis ist sofort eindeutig – manche ergeben erst zusammen einen Sinn!",
    decor: [
    ...
    seats: [
      ...
      { id: "1C", x: 64, y: 38 },
      { id: "1D", x: 80, y: 38 },
      { id: "2A", x: 20, y: 60, prop: { icon: "🥪", label: "Pausenbrot" } },
      { id: "2B", x: 36, y: 60 },
      { id: "2C", x: 64, y: 60 },
      { id: "2D", x: 80, y: 60, prop: { icon: "🥨", label: "Brezel" } },
      { id: "3A", x: 20, y: 82 },
      { id: "3B", x: 36, y: 82, prop: { icon: "🎧", label: "Kopfhörer" } },
      { id: "3C", x: 64, y: 82 },
      { id: "3D", x: 80, y: 82, prop: { icon: "🎸", label: "Gitarrenkoffer" } }
    ],
    people: [
      { id: "selma", name: "Selma", full: "Selma", icon: "👧", seat: "2D",
        hint: "Selma isst auch schon – sie sitzt auf derselben Busseite wie Frau Sommer." },
      { id: "finn", name: "Finn", full: "Finn", icon: "🧒", seat: "3D",
        hint: "Finn will am Lagerfeuer Musik machen – ohne sein Instrument geht er nirgendwohin." },
      { id: "sommer", name: "Fr. Sommer", full: "Frau Sommer", icon: "👩‍🏫", seat: "1C", fixed: true,
        hint: "Frau Sommer hat sich vorn rechts am Gang niedergelassen – Überblick ist alles." },
      { id: "ayla", name: "Ayla", full: "Ayla", icon: "👧🏻", seat: "3C",
        hint: "Ayla sitzt in der letzten Reihe, aber nicht am Fenster." },
      { id: "robin", name: "Robin", full: "Robin", icon: "🧑‍🦰", seat: "1A",
        hint: "Vor Robin sitzt nur noch Fahrer Bodo." },
      { id: "deniz", name: "Deniz", full: "Deniz", icon: "👦🏽", seat: "2A",
        hint: "Deniz hat schon vor der Abfahrt Hunger – er isst bereits." },
      { id: "pia", name: "Pia", full: "Pia", icon: "👩🏻", seat: "3B",
        hint: "Pia hört unterwegs am liebsten Hörspiele – völlig ungestört von allem." },
      { id: "kim", name: "Kim", full: "Kim", icon: "🧒🏼", seat: "1D",
        hint: "Kim sitzt am Fenster, in derselben Reihe wie Frau Sommer." },
      { id: "yara", name: "Yara", full: "Yara", icon: "👧🏽", seat: "2B",
        hint: "Yara sitzt direkt hinter Olli." },
      { id: "mats", name: "Mats", full: "Mats", icon: "👦🏼", seat: "2C",
        hint: "Mats sitzt direkt vor Ayla." },
      { id: "olli", name: "Olli", full: "Olli", icon: "👦", seat: "1B",
        hint: "Olli sitzt direkt neben Robin, auf einem Gangplatz." },
      { id: "juri", name: "Juri", full: "Juri", icon: "👦🏻", seat: "3A",
        hint: "Juri döst direkt hinter Deniz weg." }
    ]
  },
  ...
  /* ------------------------------------------------------------------
     ...
     Lösung: P1 Vega* · P2 Ronja · P3 Soraya · P4 Lasse · P5 Kosmo ·
             P6 Wanda · P7 Tarek · P8 Quentin · P9 Aiko · P10 R0B-7 ·
             P11 Chen · P12 Milo
     Deduktion: Posten nur umschrieben (Geruch, Spannung, Frühstück …) ·
     Linsen-Paar Soraya/Tarek (Mikroskop vs. Teleskop) · konsolenfreies
     Paar Chen/Milo · Ketten Milo→Wanda und Tarek→Soraya→{Ronja, Lasse}.
     ------------------------------------------------------------------ */
  {
    id: 7,
    ...
    seatScale: 0.85,
    intro:
      "Notfallübung: Heute tauscht die Crew die Posten – kaum jemand sitzt an der eigenen Konsole! " +
      "„Gegenüber“ heißt: über den Kern hinweg auf der anderen Seite des Rings. „Neben“ heißt: der " +
      "nächste Platz im Ring. Zwei Plätze haben gar keine Konsole. Überlege bei jedem Hinweis genau, " +
      "welche Konsole gemeint sein könnte – manchmal kommen mehrere infrage.",
    decor: [
    ...
    seats: [
      ...
      { id: "P3", x: 84, y: 36, prop: { icon: "🔬", label: "Mikroskop" } },
    ...
    people: [
      { id: "lasse", name: "Lasse", full: "Azubi Lasse", icon: "🧑🏼", seat: "P4",
        hint: "Azubi Lasse sitzt zwischen Soraya und der Stationskatze." },
      { id: "aiko", name: "Aiko", full: "Pilotin Aiko", icon: "👩🏻‍✈️", seat: "P9",
        hint: "Pilotin Aiko sitzt Botanikerin Soraya genau gegenüber – Blickkontakt quer über den Reaktorkern." },
      { id: "soraya", name: "Soraya", full: "Botanikerin Soraya", icon: "🧕", seat: "P3",
        hint: "Botanikerin Soraya blickt heute durch eine Linse. Winzige Proben? Ferne Sterne? Sie verrät es nicht." },
      { id: "vega", name: "Vega", full: "Kommandantin Vega", icon: "👩‍🚀", seat: "P1", fixed: true,
        hint: "Kommandantin Vega bleibt an der Navigation – irgendwer muss den Laden zusammenhalten." },
      { id: "wanda", name: "Wanda", full: "Geologin Wanda", icon: "👩‍🔬", seat: "P6",
        hint: "Geologin Wanda sitzt Funker Milo genau gegenüber." },
      { id: "rob", name: "R0B-7", full: "Wartungsroboter R0B-7", icon: "🤖", seat: "P10",
        hint: "R0B-7 dockt seinen Ladestecker direkt neben Aiko an. „Aber nicht in meiner Kombüse!“, hat der Koch gesagt." },
      { id: "kosmo", name: "Kosmo", full: "Stationskatze Kosmo", icon: "🐈", seat: "P5",
        hint: "Stationskatze Kosmo döst dort, wo es nach Desinfektionsmittel riecht. Hauptsache, die Liege ist weich." },
      { id: "milo", name: "Milo", full: "Funker Milo", icon: "👨🏽‍🚀", seat: "P12",
        hint: "Funker Milo hat einen konsolenfreien Platz erwischt – immerhin direkt neben der Kommandantin." },
      { id: "quentin", name: "Quentin", full: "Astronom Quentin", icon: "🧑🏿‍🚀", seat: "P8",
        hint: "Astronom Quentin brutzelt ausgerechnet heute das Frühstück für die ganze Crew." },
      { id: "chen", name: "Dr. Chen", full: "Dr. Chen", icon: "👩🏻‍⚕️", seat: "P11",
        hint: "Dr. Chen hat während der Übung dienstfrei – sie sitzt entspannt zwischen R0B-7 und Funker Milo." },
      { id: "tarek", name: "Tarek", full: "Koch Tarek", icon: "👨🏾‍🍳", seat: "P7",
        hint: "Auch Koch Tarek hat ein Gerät mit Linse erwischt – seines zeigt allerdings nach draußen ins All." },
      { id: "ronja", name: "Ronja", full: "Ingenieurin Ronja", icon: "👷‍♀️", seat: "P2",
        hint: "Ingenieurin Ronja sitzt direkt neben Soraya – Werkzeugtausch über die Armlehne hinweg." }
    ]
  },
  ...
  /* ------------------------------------------------------------------
     ...
     Lösung: K1 Gräfin* · O1 Berta · O2 Falk · O3 Anton · O4 Lindqvist ·
             K10 James · U1 Elfie · U2 Viktoria · U3 Polly · U4 Brand
     Deduktion: Essens-Paar Falk/Polly (Steak vs. Salat, Vegetarierin!) ·
     James über Umschreibung „Glocke nicht hören“ · Kette Viktoria→Elfie→
     Berta und Anton+James→Lindqvist · Brand per Negation.
     ------------------------------------------------------------------ */
  {
    id: 8,
    ...
    intro:
      ...
      "wer am Kopfende sitzt, ist mit beiden Seiten direkt benachbart. Lies erst alle Hinweise – " +
      "manche Gäste findest du nur über Umwege.",
    decor: [
      { type: "banner", x: 50, y: 7, text: "🔎 Krimi-Dinner – jeder ist verdächtig" },
      { type: "rect", x: 50, y: 52, w: 84, h: 22 },
      { type: "emoji", icon: "🕯️", x: 33, y: 51, size: 22 },
      { type: "emoji", icon: "🕯️", x: 67, y: 51, size: 22 },
    ...
    seats: [
      ...
      { id: "O1", x: 24, y: 33 },
      { id: "O2", x: 41.3, y: 33, prop: { icon: "🥩", label: "Steak" } },
      { id: "O3", x: 58.7, y: 33, prop: { icon: "🍷", label: "das berüchtigte Weinglas" } },
      { id: "O4", x: 76, y: 33 },
      { id: "K10", x: 93, y: 52 },
      { id: "U1", x: 24, y: 71 },
      { id: "U2", x: 41.3, y: 71, prop: { icon: "🗝️", label: "alter Schlüssel" } },
      { id: "U3", x: 58.7, y: 71, prop: { icon: "🥗", label: "Salat" } },
      { id: "U4", x: 76, y: 71 }
    ],
    people: [
      { id: "polly", name: "Polly", full: "Sekretärin Polly", icon: "👩🏻‍💼", seat: "U3",
        hint: "Sekretärin Polly wurde ebenfalls schon bedient – als überzeugte Vegetarierin." },
      { id: "brand", name: "Brand", full: "Major Brand", icon: "👨🏽‍✈️", seat: "U4",
        hint: "Major Brand sitzt auf der Kaminseite – aber keinesfalls neben der Erbin, mit der er im Streit liegt." },
      { id: "graefin", name: "Gräfin", full: "Gräfin von Rabenfels", icon: "👸🏼", seat: "K1", fixed: true,
        hint: "Die Gastgeberin thront am Kopfende, gleich neben ihrer geliebten Tischglocke." },
      { id: "lindqvist", name: "Lindqvist", full: "Professor Lindqvist", icon: "👨🏼‍🏫", seat: "O4",
        hint: "Professor Lindqvist doziert pausenlos – eingeklemmt zwischen dem Giftmischer und dem Butler." },
      { id: "elfie", name: "Elfie", full: "Nichte Elfie", icon: "👩🏼‍🦱", seat: "U1",
        hint: "Nichte Elfie sitzt zwischen ihrer Tante, der Gräfin, und Erbin Viktoria." },
      { id: "falk", name: "Falk", full: "Detektiv Falk", icon: "🕵️", seat: "O2",
        hint: "Detektiv Falk hat sein Essen bereits bekommen – Ermitteln macht hungrig." },
      { id: "james", name: "James", full: "Butler James", icon: "🤵🏻", seat: "K10",
        hint: "Butler James hat heute ausnahmsweise frei. Er sitzt so, dass er die ganze Tafel überblickt – und diese Glocke nicht ständig neben sich hat." },
      { id: "viktoria", name: "Viktoria", full: "Erbin Viktoria", icon: "💃🏼", seat: "U2",
        hint: "Erbin Viktoria sitzt direkt neben Sekretärin Polly – irgendwer muss ihr Alibi mitschreiben. (Den Gruftschlüssel trägt sie natürlich trotzdem bei sich.)" },
      { id: "berta", name: "Berta", full: "Köchin Berta", icon: "👩‍🍳", seat: "O1",
        hint: "Köchin Berta sitzt der jungen Elfie direkt gegenüber – die beiden tratschen quer über den Tisch." },
      { id: "anton", name: "Anton", full: "Gärtner Anton", icon: "🧑🏽‍🌾", seat: "O3",
        hint: "Gärtner Anton starrt nervös auf das Glas direkt vor sich. Im Spiel ist nämlich ER der Giftmischer …" }
    ]
  },
  ...
  /* ------------------------------------------------------------------
     ...
     Lösung: G1 Theo+Hamid · G2 Carla+Pepe · G3 Zofia+Ivo ·
             G4 Lotte+Ruben* · G5 Janne+Ferdi · G6 Smilla*+Mette
     Deduktion: Snack-Paar Hamid/Zofia (Popcorn vs. Eis – „so kalt“!) ·
     Ketten Zofia→{Ivo, Janne→Ferdi} und Hamid→Theo · Pepe→Carla ·
     Lotte über die Schießstand-Geschichte.
     ------------------------------------------------------------------ */
  {
    id: 9,
    ...
    intro:
      ...
      "„Direkt unter/über“ meint eine im Ring benachbarte Gondel, die tiefer bzw. höher hängt; „gleich hoch“ die " +
      "Gondel auf gleicher Höhe der anderen Radseite. Links und rechts gelten aus deiner Sicht. Manche Hinweise passen zunächst auf " +
      "mehrere Plätze – kombiniere!",
    decor: [
    ...
    seats: [
      { id: "G1a", x: 45, y: 12 },
      { id: "G1b", x: 55, y: 12, prop: { icon: "🍿", label: "Popcorntüte" } },
      { id: "G2a", x: 76, y: 30.5 },
      { id: "G2b", x: 86, y: 30.5, prop: { icon: "🎈", label: "Luftballon" } },
      { id: "G3a", x: 76, y: 67.5, prop: { icon: "🍦", label: "Eiswaffel" } },
      { id: "G3b", x: 86, y: 67.5 },
      { id: "G4a", x: 45, y: 86, prop: { icon: "🧸", label: "Teddybär" } },
      { id: "G4b", x: 55, y: 86 },
      { id: "G5a", x: 14, y: 67.5 },
      { id: "G5b", x: 24, y: 67.5 },
    ...
    people: [
      { id: "ferdi", name: "Ferdi", full: "Ferdi", icon: "👨🏻", seat: "G5b",
        hint: "Ferdi sitzt rechts von Janne, in derselben Gondel." },
      { id: "zofia", name: "Zofia", full: "Zofia", icon: "👩🏻", seat: "G3a",
        hint: "Auch Zofia hat sich am Kiosk etwas geholt – ihr tropft gleich die Hälfte davon aufs Knie, so kalt ist es." },
      { id: "mette", name: "Mette", full: "Mette", icon: "👩🏼", seat: "G6b",
        hint: "Mette quetscht sich zu Smilla in die Gondel – Selfie-Time!" },
      { id: "ruben", name: "Ruben", full: "Ruben", icon: "🧑🏽", seat: "G4b", fixed: true,
        hint: "Ruben sitzt ganz unten in der Einstiegsgondel und atmet erst mal tief durch." },
      { id: "carla", name: "Carla", full: "Carla", icon: "👩🏽", seat: "G2a",
        hint: "Carla sitzt links neben dem kleinen Pepe und hält sicherheitshalber den Ballonknoten fest." },
      { id: "hamid", name: "Hamid", full: "Hamid", icon: "👨🏾", seat: "G1b",
        hint: "Hamid hat sich am Kiosk etwas zum Knabbern geholt und futtert schon." },
      { id: "smilla", name: "Smilla", full: "Fotografin Smilla", icon: "👩🏻‍🦰", seat: "G6a", fixed: true,
        hint: "Fotografin Smilla hat das Stativ ausgefahren – von ihrer Gondel aus ist das Panorama perfekt." },
      { id: "janne", name: "Janne", full: "Janne", icon: "🧑🏼‍🦱", seat: "G5a",
        hint: "Jannes Gondel hängt genauso hoch wie Zofias – nur auf der anderen Seite des Rads." },
      { id: "theo", name: "Theo", full: "Theo", icon: "👦🏻", seat: "G1a",
        hint: "Theo teilt sich die Gondel mit Hamid – und hat ihm schon das halbe Popcorn weggefuttert." },
      { id: "lotte", name: "Lotte", full: "Oma Lotte", icon: "👵🏼", seat: "G4a",
        hint: "Oma Lotte hat am Schießstand allen Ernstes einen Hauptpreis geholt. Ihr flauschiger Gewinn fährt auf dem Schoß mit." },
      { id: "ivo", name: "Ivo", full: "Ivo", icon: "🧔🏻", seat: "G3b",
        hint: "Ivo sitzt neben Zofia und passt auf, dass nichts davon auf IHN tropft." },
      { id: "pepe", name: "Pepe", full: "Pepe", icon: "👶", seat: "G2b",
        hint: "Der kleine Pepe will richtig baumeln: Seine Gondel hängt direkt unter der von Hamid – und er sitzt rechts." },
    ]
  },
  ...
  /* ------------------------------------------------------------------
     ...
     Lösung: Afv Leokadia · Afr Tilda · Agv Knopp · Agr Adler*
             Bfv Sorel · Bfr Mio · Bgv Samu · Bgr Falter
             Cfv Ewald* · Cfr Waldi · Cgv Wieser · Cgr Nora
             Dfv Viggo · Dfr Tomma · Dgv Ines · Dgr Jo
     Deduktion: Dessert-Paar Sorel/Leokadia („bloß keine Schokotorte!“) ·
     Getränke-Paar Wieser/Falter (Krimi-Rotwein) · Schachturnier-Umschreibung ·
     lange Ketten Leokadia→Sorel→Mio→{Tilda, Samu} und Falter→{Wieser→
     {Knopp, Nora}, Jo→Ines} sowie Viggo→Tomma.
     ------------------------------------------------------------------ */
  {
    id: 10,
    ...
    intro:
      ...
      "(2 → 1 bzw. 4 → 3). Hier führt kein Hinweis allein ans Ziel – du brauchst die Kombination.",
    decor: [
    ...
    seats: [
      { id: "Afv", x: 20, y: 23.5, prop: { icon: "🍮", label: "Kaiserschmarrn" } },
      { id: "Afr", x: 36, y: 23.5 },
      { id: "Agv", x: 20, y: 38.5 },
      { id: "Agr", x: 36, y: 38.5, prop: { icon: "☕", label: "Pausenkaffee" } },
      { id: "Bfv", x: 64, y: 23.5, prop: { icon: "🍰", label: "Schokotorte" } },
      { id: "Bfr", x: 80, y: 23.5 },
      { id: "Bgv", x: 64, y: 38.5 },
      { id: "Bgr", x: 80, y: 38.5, prop: { icon: "🍷", label: "Rotweinglas" } },
      { id: "Cgv", x: 20, y: 65.5, prop: { icon: "🍵", label: "Teekanne" } },
      { id: "Cgr", x: 36, y: 65.5 },
      { id: "Cfv", x: 20, y: 80.5 },
      { id: "Cfr", x: 36, y: 80.5, prop: { icon: "🦴", label: "Leckerli" } },
      { id: "Dgv", x: 64, y: 65.5 },
      { id: "Dgr", x: 80, y: 65.5 },
    ...
    people: [
      { id: "nora", name: "Nora", full: "Studentin Nora", icon: "👩🏼‍🎓", seat: "Cgr",
        hint: "Studentin Nora sitzt Dr. Wieser direkt gegenüber und schreibt eifrig mit, was die Richterin erzählt." },
      { id: "viggo", name: "Viggo", full: "Viggo", icon: "👨🏻‍🦳", seat: "Dfv",
        hint: "Großmeister Viggo reist zum großen Schachturnier nach Wien. Er sitzt an Ines’ Tisch und blickt in Fahrtrichtung – Eröffnungen studieren!" },
      { id: "tilda", name: "Tilda", full: "Zwilling Tilda", icon: "👱🏻‍♀️", seat: "Afr",
        hint: "Zwilling Tilda sitzt auf demselben Platz wie der kleine Mio – nur einen Tisch weiter hinten." },
      ...
      { id: "jo", name: "Jo", full: "Backpacker Jo", icon: "🧑🏾‍🦱", seat: "Dgr",
        hint: "Backpacker Jo sitzt jenseits des Mittelgangs auf gleicher Höhe wie Krimiautor Falter." },
      { id: "sorel", name: "Mme Sorel", full: "Madame Sorel", icon: "👩🏽‍🎤", seat: "Bfv",
        hint: "Madame Sorel hat sich ein Dessert vorbestellt – nach der Premiere gönnt sie sich was." },
      { id: "knopp", name: "Knopp", full: "Herr Knopp", icon: "👨🏼‍💼", seat: "Agv",
        hint: "Herr Knopp sitzt jenseits des Mittelgangs auf gleicher Höhe wie Dr. Wieser – das Ohr mal wieder am Telefon." },
      { id: "waldi", name: "Waldi", full: "Dackel Waldi", icon: "🐕", seat: "Cfr",
        hint: "Dackel Waldi reist mit eigener Fahrkarte! Er döst seinem Herrchen Ewald direkt gegenüber, das Wien-Leckerli in Reichweite." },
      { id: "ines", name: "Ines", full: "Ines", icon: "👩🏾", seat: "Dgv",
        hint: "Ines sitzt Backpacker Jo direkt gegenüber – sein Reisetagebuch will sie unbedingt lesen." },
      { id: "leokadia", name: "Leokadia", full: "Oma Leokadia", icon: "👵🏽", seat: "Afv",
        hint: "Oma Leokadia hat ebenfalls ein Dessert bestellt – aber bloß nicht schon wieder Schokotorte!" },
      { id: "samu", name: "Samu", full: "Azubi Samu", icon: "🧑🏽‍🎓", seat: "Bgv",
        hint: "Azubi Samu sitzt diagonal gegenüber vom kleinen Mio und passt auf, dass der nicht zu viel Süßes stibitzt." },
      ...
      { id: "tomma", name: "Tomma", full: "Zwilling Tomma", icon: "👱🏼‍♀️", seat: "Dfr",
        hint: "Zwilling Tomma sitzt Viggo direkt gegenüber und himmelt den Schachmeister unverhohlen an." },
      { id: "falter", name: "Falter", full: "Krimiautor Falter", icon: "🧑🏻‍💻", seat: "Bgr",
        hint: "Krimiautor Falter hat sich ein Getränk vorbestellt: Für seine Mörderszene braucht er einen kräftigen Roten." },
      { id: "wieser", name: "Dr. Wieser", full: "Richterin Dr. Wieser", icon: "👩🏻‍⚖️", seat: "Cgv",
        hint: "Auch Richterin Dr. Wieser hat sich ein Getränk reservieren lassen." },
      { id: "mio", name: "Mio", full: "Mio", icon: "🧒🏻", seat: "Bfr",
        hint: "Der kleine Mio sitzt Madame Sorel direkt gegenüber und bestaunt ihr Dessert mit großen Augen." }
    ]
  }
];
